...
public class S3SinkConnectorStsAssumeRoleIT extends BaseConnectorIT {
  ...
  private static final String ROLE_EXTERNAL_ID = "integration-test-id";
  private static final String ROLE_ARN = "arn:aws:iam::581884925347:role/ConnectS3IntegrationTestingAssumeRole";
  ...
  // TODO: Fetch AWS Credentials dynamically
  // v1/ci/kv/data/semaphore2/CONNECT_S3_SINK_IT
