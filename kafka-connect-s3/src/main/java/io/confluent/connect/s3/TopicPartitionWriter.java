...
public class TopicPartitionWriter {
    ...
    private void commitFiles() {
        ...
        for (Map.Entry<String, String> entry : commitFiles.entrySet()) {
            ...
            pathPrefix = getDirectoryPrefix(encodedPartition) + dirDelim;
        ...
        String nowPrefix = tp.topic() + dirDelim + encodeTimestamp(
                ...
                timeZoneString,
                time.milliseconds());
        log.info("pathPrefix {} nowPrefix {}", pathPrefix, nowPrefix);
        if (commitFilesName.size() > 1 || !commitFilesName.contains(nowPrefix)) {
            String tagFile = topicsDir + dirDelim + pathPrefix + dirDelim + "_SUCCESS";
