...
public class JsonFormat implements Format<GcsSinkConnectorConfig, String> {
  private final GcsStorage storage;
  private final JsonConverter converter;

  public JsonFormat(GcsStorage storage) {
    ...
    converterConfig.put(
        "schemas.cache.size",
        String.valueOf(storage.conf().get(GcsSinkConnectorConfig.SCHEMA_CACHE_SIZE_CONFIG))
    );
