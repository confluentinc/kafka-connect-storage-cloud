...
package io.confluent.connect.azure.util;
...
import static io.confluent.connect.azure.AzBlobSinkConnectorConfig.S3_PROXY_PASS_CONFIG;
import static io.confluent.connect.azure.AzBlobSinkConnectorConfig.S3_PROXY_URL_CONFIG;
import static io.confluent.connect.azure.AzBlobSinkConnectorConfig.S3_PROXY_USER_CONFIG;
...
public class S3ProxyConfig {
  ...
  public S3ProxyConfig(AzBlobSinkConnectorConfig config) {
    try {
